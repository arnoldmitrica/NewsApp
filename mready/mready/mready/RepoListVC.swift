...
//        print("height: \(height)")
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        detailVC.viewModel = RepositoryDetailViewModel
        detailVC.viewModel = RepositoryDetailViewModel(cell, itemDescription: item.itemDescription ?? "No description", language: item.language, avatarOwnerURL: item.owner.avatarURL, ownerName: item.owner.login, forkCount: item.forksCount, stargazersCount: item.stargazersCount, updatedAt: item.updatedAt)
